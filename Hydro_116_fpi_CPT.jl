...
ax3 = Axis(fig[2, 1], xlabel="x", ylabel="Pressure", title="p(x)")
ax4 = Axis(fig[2, 2], xlabel="x", ylabel="e", title="e(x)")
...
scatter!(ax4, x[1:2:end], e_final[1:2:end], markersize=6, color = :violet)
