...
function initial_condition(x)
    ρ, v, p = x < L_mid ?   (1.0,-0.6,10.0) : (10.0,0.5,20.0)  #(10.0,0.0,13*(1/3)) : (1.0,0.0,(2/3)*(10^-6)) # (1.0,0,1.0) : (0.125,0,0.1) #(10.0,0.0,13*(1/3)) : (1.0,0.0,(2/3)*(10^-6))
...
ax1 = Axis(fig[1, 1], xlabel="x", ylabel="Relativistic Density",xticks = 0:0.1:1, title="D(x)")
ax2 = Axis(fig[1, 2], xlabel="x", ylabel="Velocity",xticks = 0:0.1:1, title="v(x)")
ax3 = Axis(fig[1, 3], xlabel="x", ylabel="Pressure",xticks = 0:0.1:1, title="p(x)")
